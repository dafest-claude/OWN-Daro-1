...
OUT_PNG = os.path.join(SCRIPT_DIR, 'Infografico_RI_OC_IN_EL_LaCalera_II_Rev15_180926.png')
...
axT.text(0.015, 0.22, 'La Calera II CPF2  ·  Instrumentación (IN) y Electricidad (EL)  ·  '
                      'Plan 180926 (Rev15)  ·  corte 18/09/2026  ·  evolución 21/08→18/09',
...
axN.text(0.0,0.5,'SEMANA 11/09→18/09:', fontsize=10.5, fontweight='bold', color=AZUL,
         transform=axN.transAxes, va='center')
axN.text(0.155,0.5,'+4 OCs IN+EL (32→36: IN 22→25, EL 10→11)   ·   petición casi vaciada (6→1)   ·   '
                   'SE#3: posible impacto precio/plazo   ·   Válvulas: único sin OC (148 d)',
...
axP.annotate('AT y OC parejos', xy=(2.19,23), xytext=(1.15,30),
...
items = [
    ...
    ('IN','Válvulas Control','23/04','flete aéreo','148 d*','ÚNICO SIN OC', ROJO),
]
...
axI.text(0.0,-0.04,'(*) al corte 18/09/26. +4 OCs esta semana (IN+EL 32→36; 52% de las 69 RIs). 6 de 7 críticos con OC. Válvulas: único sin OC (148 d) – pendiente validación final.  '
