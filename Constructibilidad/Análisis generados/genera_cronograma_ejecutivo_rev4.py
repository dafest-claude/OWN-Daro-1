...
# -*- coding: utf-8 -*-
"""
CRONOGRAMA EJECUTIVO — Provisiones críticas CPF-2 (Rev4, 2026-09-23).
...
REV="Rev4"; FECHA="2026-09-23"; HOY=date(2026,9,23)
...
NOTAS=[
 ...
 "Fuentes: ABB Salas y Ductos 5155-00-0009-VE-CO-PG-001_A (21-08-26) · ABB PMS 5155-00-0007-VE-CO-PG-001_REV B (.mpp) · Inauco 5155-00-0029-VE-CO-PG-001-A Rev.A (24-08-26) y 5155-00-0029-VE-CA-PG-002 Rev.0 (14-09-26) · HPH 103618-Schedule 16-08-26 · HARG PSCH_CPF2_Rev3 (04-09-26) con corrimiento +49 d.",
...
INTERFASES=[
 ...
 "AESA → layout de instalación + detalle de conexionado a trafo (29/08/26): condiciona el inicio de diseño de los DUCTOS DE BARRAS (entrega 10/06/27, la más tardía del paquete).",
...
ws.merge_cells("A3:K3"); cell(ws,3,1,f"Fecha de corte del estado: {HOY.strftime('%d/%m/%Y')}   ·   CAMINO CRÍTICO: OC HARG → HPH → HARG → Inauco, cierre 10/05/2027   ·   {len(PUNTOS)} puntos de atención abiertos (PA-01 a PA-06)",None,"C62828",True,9)
