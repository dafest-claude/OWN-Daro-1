...
# -*- coding: utf-8 -*-
"""
CRONOGRAMA EJECUTIVO — Provisiones críticas CPF-2 (Rev1, 2026-09-02).
...
REV="Rev1"; FECHA="2026-09-02"; HOY=date(2026,9,2)
...
PROV=[
 ("ABB — Sala Eléctrica SE#3 (BT)","ABB","C62828",[
  ...
  ("H03","Confirmación de layout de sala y equipamiento",D(2026,5,18),D(2026,5,20),0,"Insumo AESA"),
  ("H04","Emisión de ingeniería básica",D(2026,5,20),D(2026,8,28),0,""),
  ("H05","Aprobación de ingeniería básica",D(2026,8,28),D(2026,9,11),0,"Aprobación AESA"),
  ("H06","FREEZING POINT — ingeniería básica",D(2026,9,11),D(2026,9,11),1,"Hito explícito del cronograma ABB"),
  ("H07","Emisión de ingeniería de detalle",D(2026,5,22),D(2026,9,21),0,""),
  ("H08","Aprobación de ingeniería de detalle",D(2026,9,21),D(2026,10,5),0,"Aprobación AESA"),
  ("H09","FREEZING POINT — ingeniería de detalle",D(2026,10,5),D(2026,10,5),1,"Cierra ingeniería del shelter"),
  ("H10","Inicio compra y acopio de materiales",D(2026,5,19),D(2026,5,19),0,""),
  ("H11","Acopio de materiales completo",D(2026,12,10),D(2026,12,10),1,"Materiales críticos en fábrica"),
  ("H12","Inicio de fabricación / armado",D(2026,11,2),D(2026,11,2),0,""),
  ("H13","Fin de fabricación de tableros",D(2027,2,26),D(2027,2,26),1,""),
  ("H14","Montaje e integración de equipos en sala",D(2027,2,19),D(2027,3,15),0,"Shelterista"),
  ("H15","Interconexión de equipos",D(2027,3,16),D(2027,3,23),0,""),
  ("H16","FAT Sala Eléctrica",D(2027,3,25),D(2027,3,30),1,"Witness AESA"),
  ("H17","Ensayos PMS en sala (INTERFASE — contrato PMS)",D(2027,3,31),D(2027,4,6),0,"Alcance del contrato PMS; se controla en su propia línea"),
  ("H18","DESPACHO / ENTREGA EXW",D(2027,4,21),D(2027,4,23),1,"HITO FINAL — cierre del alcance de la sala"),
 ]),
 ("ABB — Sala Eléctrica SE#4 (MT)","ABB","AD1457",[
  ...
  ("H09","FREEZING POINT — ingeniería de detalle",D(2026,10,5),D(2026,10,5),1,"Cierra ingeniería del shelter"),
  ("H10","Inicio compra y acopio de materiales",D(2026,5,19),D(2026,5,19),0,""),
  ("H11","Acopio de materiales completo",D(2026,12,10),D(2026,12,10),1,""),
  ("H12","Inicio de fabricación / armado",D(2026,10,5),D(2026,10,5),0,""),
  ("H13","Fin de fabricación de tableros",D(2027,1,21),D(2027,1,21),1,"Incluye celdas MT"),
  ("H14","Montaje e integración de equipos en sala",D(2027,1,21),D(2027,2,22),0,"Shelterista"),
  ("H15","Interconexión de equipos",D(2027,2,11),D(2027,2,23),0,""),
  ("H16","FAT Sala Eléctrica",D(2027,2,24),D(2027,3,1),1,"Witness AESA"),
  ("H17","Ensayos PMS en sala (INTERFASE — contrato PMS)",D(2027,3,2),D(2027,3,9),0,"Alcance del contrato PMS; se controla en su propia línea"),
  ("H18","DESPACHO / ENTREGA EXW",D(2027,3,19),D(2027,3,25),1,"HITO FINAL — cierre del alcance de la sala"),
 ]),
 ("ABB — Ductos de barras","ABB","795548",[
  ("H01","Inicio de contrato — Recepción de OC",D(2026,5,8),D(2026,5,8),0,"Mismo contrato ABB (alcance separado)"),
  ("H02","Emisión layout instalación + detalle conexionado trafo",D(2026,7,20),D(2026,8,29),1,"INSUMO AESA — condiciona el inicio de diseño"),
  ("H03","FREEZING POINT — inicio de diseño",D(2026,8,29),D(2026,8,29),1,"Hito explícito del cronograma ABB"),
  ("H04","Diseño de ductos de barras",D(2026,8,31),D(2026,11,20),0,""),
  ("H05","FREEZING POINT — cierre de diseño",D(2026,12,4),D(2026,12,4),1,"Habilita fabricación"),
  ("H06","Fabricación de ductos de barras",D(2026,12,4),D(2027,3,14),1,"100 días corridos"),
  ("H07","FCA fábrica de origen",D(2027,3,15),D(2027,3,19),1,"Puesta a disposición en origen"),
  ("H08","Traslado internacional + aduana",D(2027,3,19),D(2027,6,7),1,"80 días corridos — tramo más largo"),
  ("H09","ENTREGA DE EQUIPOS EN SITIO",D(2027,6,8),D(2027,6,10),1,"HITO FINAL — la entrega más tardía del paquete ABB"),
 ]),
 ...
 ("Inauco — PCS / SCADA / Comunicaciones","Inauco","1565C0",[
  ...
  ("H17","ENTREGA DE EQUIPOS (post-FAT)",D(2027,5,17),D(2027,5,17),1,"HITO FINAL — cierre post-FAT; habilita el inicio de campo"),
 ]),
...
NOTAS=[
 ...
 "Rev1: se verificó que la entrega en sitio del 08/10-06-27 corresponde a la provisión de DUCTOS DE BARRAS y no a las salas; se la separó en su propia línea de seguimiento. Las Salas SE#3 y SE#4 cierran en su DESPACHO / ENTREGA EXW.",
 "Rev1: la entrega de Inauco se fija en la fecha POST-FAT (17/05/27), al cierre de las configuraciones posteriores a la FAT.",
 "Rev1: el PMS se mantiene como línea separada para control propio de ese equipamiento. Los ensayos de PMS que figuran dentro de las salas se marcan como INTERFASE (su control corresponde a la línea del contrato PMS).",
 "Fuentes (últimas revisiones cargadas): ABB Salas y Ductos de barras 5155-00-0009-VE-CO-PG-001_A (21-08-26) · ABB PMS 5155-00-0007-VE-CO-PG-001_REV B (.mpp) · Inauco 5155-00-0029-VE-CO-PG-001-A Rev.A (24-08-26) · HIMA 103618-Schedule 16-08-26 (draft).",
 "Los FREEZING POINTS de ABB (Salas y Ductos) son hitos explícitos del cronograma del proveedor; en PMS, Inauco y HIMA se toma el cierre/aprobación de ingeniería como freezing point equivalente.",
 ...
 "Interfases clave: HIMA → recepción de tableros en Inauco (25-01-27) habilita la FAT SIS · ABB PMS → entrega en shelter (17-02-27) habilita los ensayos PMS en las salas · PCS↔PMS pruebas en Bs.As. (28-04 → 04-05-27) · AESA → layout/conexionado trafo (29-08-26) condiciona el diseño de los ductos de barras.",
]
